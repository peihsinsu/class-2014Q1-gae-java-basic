...
public class CalendarDetails {
	/*
	 * Use the Calendar API to get a list of upcoming events for the
	 * AUTHENTICATED user
	 */
	public static String getCalendarItems(Calendar service) throws IOException {
		...
		if (items != null) {
			for (Event event : items) {
				...
				calendarInfo += "<h3 style=\"color:blue\";>"
						+ event.getSummary() + "</h3>" + "<p> organized by "
						+ orgEmail + "</p>" + "<p>scheduled for " + startTime
						+ "</p>";

				System.out.println("CalendarDetail:" + event.getSummary());
			}
		}
		return calendarInfo;
	}
